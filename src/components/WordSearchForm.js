...
const SearchForm = () => {
  ...
  const panels = [
      ...
      title: {
        content: (
          <Label
            basic
            size="large"
            content="Use one ? for each individual unknown letter."
          />
        ),
      },
      content: {
        content: <span>Example: b?ar might return bear, or boar.</span>,
      },
    },
    {
      key: 'instruction-two',
      title: {
        content: (
          <Label
            basic
            size="large"
            content="Use numeric digits 1 - 9 for two or more of the same letter."
          />
        ),
      },
      content: {
    ...
    {
      key: 'instruction-three',
      title: {
        content: (
          <Label
            basic
            size="large"
            content="(Optional) Exclude or filter specific letters from results."
          />
        ),
      },
      content: {
      ...
      <Form>
        ...
        {results.length > 0 ? (
          <>
            ...
            <Button color="teal" size="large" onClick={resetForm}>
              Reset Form
            </Button>
          </>
        ) : (
